...
func doinit() {
	...
	if S390X.HasMSA {
		...
		if S390X.HasKDSA {
			//kdsa := kdsaQuery()
			kdsa := kdsaFunction(0)
			S390X.HasECDSAP256 = kdsa.Has(ecdsaVerifyP256,ecdsaSignP256)
			S390X.HasECDSAP384 = kdsa.Has(ecdsaVerifyP384,ecdsaSignP384)
			S390X.HasECDSAP521 = kdsa.Has(ecdsaVerifyP521,ecdsaSignP521)
			S390X.HasEDDSAEd25519 = kdsa.Has(eddsaVerifyEd25519,eddsaSignEd25519)
			S390X.HasEDDSAEd448 = kdsa.Has(eddsaVerifyEd448,eddsaSignEd448)
		}
	}
	if S390X.HasVX {
